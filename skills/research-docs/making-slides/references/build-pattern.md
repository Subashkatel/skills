...
- Margins 0.7 in each side (content width 11.93); title at y ≈ 0.45, size 30 at text weight, centered.
...
The mirror is a draft renderer. Inspect a render of the actual pptx when
available; if unavailable, state that exact font metrics, wrapping, and playback
remain unverified. Do not claim pixel equivalence from a shared layout alone.
